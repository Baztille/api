...
class notifier
{
    ...
    public function onQuestionSelected( $question )
    {
        ...
        $body .= "<br><a href=\"".$g_config['app_base_url'].'/question/questions/'.( (string)$question['_id'] )."?source=email&title=question-a-voter\" class=\"btn-primary\" style=\"background-color: #00A8D0; border-radius:5px; color: #fff; position: relative; display: inline-block;margin: 0;padding: 0 12px; min-width: 52px; min-height: 33px; vertical-align: top; text-align: center; text-overflow: ellipsis; font-size: 14px; line-height: 32px; margin-top:20px; margin-bottom:20px;\">Votez</a>";
        ...
        $body .= "<br><a href=\"".$g_config['app_base_url']."/question/proposed?source=email&title=questions-proposees\" class=\"btn-secondary\" style=\"color: #000; position: relative; display: inline-block; vertical-align: top; text-align: center; text-overflow: ellipsis; margin-top:10px; margin-bottom:10px; text-decoration:underline;\">Proposez une question</a>";
        ...
        $body .= "<br><a href=\"".$g_config['app_base_url']."/question/voted?source=email&title=tous-les-resultats\" class=\"btn-secondary\"  style=\"color: #000; position: relative; display: inline-block; vertical-align: top; text-align: center; text-overflow: ellipsis; margin-top:10px; margin-bottom:10px; text-decoration:underline;\">Tous les résultats</a> ";
    ...
    public function onAnswerApproved( $question )
    {
        ...
        foreach( $question['validanswers'] as $answer )
        {
            ...
            if( $answer['author'] )
            {
                ...
                $body .= "<br><a href=\"".$g_config['app_base_url'].'/question/questions/'.( (string)$question['_id'] )."?source=email&title=reponse-approuvee\" class=\"btn-primary\" style=\"background-color: #00A8D0; border-radius:5px; color: #fff; position: relative; display: inline-block;margin: 0;padding: 0 12px; min-width: 52px; min-height: 33px; vertical-align: top; text-align: center; text-overflow: ellipsis; font-size: 14px; line-height: 32px; margin-top:20px; margin-bottom:20px;\">Voir la question</a>";
                $body .= "<br>... et vous avez gagné 100 points Baztille !";
        ...
        $body .= "Cette réponse sera celle défendue par les élus du mouvement Baztille ... à moins que vous n'en décidiez autrement une prochaine fois !";


        $body .= "<br><br>";

        $body .= "Il vous reste encore 24h pour décider de la prochaine question qui sera posée à la communauté :";
        $body .= "<br><a href=\"".$g_config['app_base_url']."/question/proposed?source=email&title=decider-prochaine-question\" class=\"btn-primary\" style=\"background-color: #00A8D0; border-radius:5px; color: #fff; position: relative; display: inline-block;margin: 0;padding: 0 12px; min-width: 52px; min-height: 33px; vertical-align: top; text-align: center; text-overflow: ellipsis; font-size: 14px; line-height: 32px; margin-top:20px; margin-bottom:20px;\">Voir les questions</a>";
